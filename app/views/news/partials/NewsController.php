...
class NewsController extends BaseController {
    ...
    public function getIndex()
    {
        ...
        $recommends     = Article::with('img')->rand()->recommendList(['hynews', 'ydnews', 'yxnews', 'faq', 'ghnews'])->take(6)->get();
        $hot_tags       = Recommend::with('tag')->whereRecommendTypeCode('hot_tag')->get();

        $weekly_list    = Statistic::articleWeeklyList()->take(6)->get();
    ...
    public  function getTag($id)
    {
        ...
        /*TAG电商资讯推荐阅读*/
        $recommends = Article::with('img')->orderBy('updated_at','DESC')->take(6)->get();
    ...
    public function getList($type)
    {
        ...
        $latest_news =Article::with('images')->recommendList($type)->take(4)->get();
    ...
    public function getDetail($id)
    {
        ...
        if($type !== 'faq')
        {
            ...
            $recommends = Article::with('images')->recommendList($type, $id)->take(6)->get();
